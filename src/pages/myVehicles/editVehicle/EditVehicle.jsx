...
const EditVehicle = () => {
  ...
  console.log("singleVehicle", singleVehicle.data);
  ...
  const single_vehicle = singleVehicle?.data;

  // 🚀 Form Fields Update with API Data
  useEffect(() => {
    if (single_vehicle) {
      form.setFieldsValue({
        thumbnail_image: single_vehicle.thumbnail_image || "",
        price: single_vehicle.price || 0,
        discount_price: single_vehicle.discount_price || 0,
        make: single_vehicle.make || "",
        model: single_vehicle.model || "",
        // year_of_manufacture: single_vehicle.year_of_manufacture || "",
        mileage: single_vehicle.mileage || "",
        fuel_type: single_vehicle.fuel_type || "",
        transmission: single_vehicle.transmission || "",
        body_type: single_vehicle.body_type || "",
        seating_capacity: single_vehicle.seating_capacity || "",
        doors: single_vehicle.doors || "",
        engine_capacity_cc: single_vehicle.engine_capacity_cc || "",
        fuel_efficiency_kmpl: single_vehicle.fuel_efficiency_kmpl || "",
        drive_type: single_vehicle.drive_type || "",
        color: single_vehicle.color || "",
        interior_color: single_vehicle.interior_color || "",
        description: single_vehicle.description || "",
        vehicle_condition: single_vehicle.vehicle_condition || "",
        registration_number: single_vehicle.registration_number || "",
        registration_year: single_vehicle.registration_year || "",
        rtn: single_vehicle.rtn || "",
        power: single_vehicle.power || "",
        cabin_size: single_vehicle.cabin_size || "",
        trunk_size: single_vehicle.trunk_size || "",
        top_speed: single_vehicle.top_speed || "",
        vin_number: single_vehicle.vin_number || "",
        trim: single_vehicle.trim || "",
        division: single_vehicle.division || "",
        district: single_vehicle.district || "",
        upzila: single_vehicle.upzila || "",
        city: single_vehicle.city || "",
        status: single_vehicle.status || "",
      });
    }
  }, [single_vehicle, form]);
